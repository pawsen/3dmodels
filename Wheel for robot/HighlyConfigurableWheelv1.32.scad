...
wheelWidth     = 8;     // The width (or thickness) of the wheel at the rim.
...
knobSize          = [8,1.5,1];   // The size of each knob [across wheel, along the perimeter, prodruding]
...
hubDiameter          = 17;    // The diameter of the hub portion of the wheel
hubHeight            = 10;    // The total height of the hub
hubZOffset           = 0;     // The Z position of the hub, negative numbers from the surface of the wheel 
innerCircleDiameter  = 17;    // The diameter of the solid inner circle under the hub, or zero for none. 
...
shaftDiameter        = 7;          // The diameter of the motor shaft
